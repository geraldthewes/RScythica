...
#ifndef SDS_FACTVECTOR_H
#define SDS_FACTVECTOR_H
...
namespace rscythica {
  ...
  class SFactorVector {
    public:
       ...
       SEXP  select_op_ge(SEXP v, SEXP out, int value);
       SEXP  select_op_le(SEXP v, SEXP out, int value);
 
       SEXP collapse(SEXP src, SEXP lv);
  };
}

#endif /* SDS_FACTVECTOR_H */